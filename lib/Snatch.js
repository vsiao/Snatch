...
Snatch.prototype._checkAttempt = function(data) {
  this.room.announce('attempt', data);
  if (data.word.length < MIN_WORD_LEN ||
      !Dictionary.isWord(data.word)) {
    return;
  }
  var i, playerIdx;
